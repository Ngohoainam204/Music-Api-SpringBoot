...
public class SongController {
    ...
    @PutMapping("/{id}")
    public ApiResponse<SongResponse> updateSongById(@PathVariable Long id,@RequestBody SongUpdateRequest request){
    ...
    @DeleteMapping("/{id}")
    public ApiResponse<SongResponse> deleteSongById(@PathVariable Long id){
